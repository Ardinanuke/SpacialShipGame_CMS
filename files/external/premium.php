                ...
                <div class="module">
                    <div class="module-head">
                        <h3 style="text-align: center;">
                            Donate now and help us keeping DeathSpace online</h3>
                    </div>

                    <center>
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-condensed" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <input type="hidden" name="business" value="leon.luisgerardo775@gmail.com">

                                            <!-- Specify a Buy Now button. -->
                                            <input type="hidden" name="cmd" value="_donations">

                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="1.000.000 Uridium (ID : <?php echo $player['userId']; ?> )">
                                            <input type="hidden" name="amount" value="15.00">
                                            <input type="hidden" name="custom" value="">
                                            <input type="hidden" name="currency_code" value="EUR">

                                            <!-- Display the payment button. -->
                                            <input type="image" name="submit" border="0" src="https://nsm09.casimages.com/img/2018/02/21//18022109153514214815572855.png" alt="PayPal - The safer, easier way to pay online">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="1.500.000 Uridium (ID : <?php echo $player['userId']; ?> )">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="25.000.000 Uridium (ID : <?php echo $player['userId']; ?> )">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Goliath Independence(ID : <?php echo $player['userId']; ?> )">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Goliath Turkish (ID : <?php echo $player['userId']; ?> )">
                                            <input type="hidden" name="amount" value="5.00">
                                            <input type="hidden" name="custom" value="">
                                            <input type="hidden" name="currency_code" value="EUR">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Goliath Orion (ID : <?php echo $player['userId']; ?> )">
                                            <input type="hidden" name="amount" value="15.00">
                                            <input type="hidden" name="custom" value="">
                                            <input type="hidden" name="currency_code" value="EUR">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Goliath Razer (ID : <?php echo $player['userId']; ?> )">
                                            <input type="hidden" name="amount" value="5.00">
                                            <input type="hidden" name="custom" value="">
                                            <input type="hidden" name="currency_code" value="EUR">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Pack S1 (ID : <?php echo $player['userId']; ?> )">
                                            <input type="hidden" name="amount" value="20.00">
                                            <input type="hidden" name="custom" value="">
                                            <input type="hidden" name="currency_code" value="EUR">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                            ...
                                            <!-- Specify details about the item that buyers will purchase. -->
                                            <input type="hidden" name="item_name" value="Pack Trinity (ID : <?php echo $player['userId']; ?> )">
